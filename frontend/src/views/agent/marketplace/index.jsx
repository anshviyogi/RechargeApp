...
const Accounts = () => {
  ...
  const [role, setRole] = useState("PDO");
  ...
  function submitHandler(e) {
    ...
    if(adharNumber === "" || panNumber === ""){
      return toast.warn("Kindly fill your Adhar and Pan Card details in the verify box")
    }
            ...
            <>
              ...
              <div className="modal">
                <div className="modal-box relative">
                  ...
                  <input value={`${firstName} ${lastName}`} disabled className="bg-gray-50 border border-gray-600 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="As mentioned in the outer fields"/>
                  </div>

                  <div className="mt-2">
                  <label className="font-primary text-textlight text-left text-sm font-semibold">Adhar Card Number</label>
                  <input value={adharNumber} onChange={(e) => setAdharNumber(e.target.value)} className="bg-gray-50 border border-gray-600 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-bold" placeholder="XXXX XXXX XXXX XXXX" type="number"/>
                  </div>

                  <div className="mt-2">
                  <label className="font-primary text-textlight text-left text-sm font-semibold">Pan Card Number</label>
                  <input value={panNumber} onChange={e => setPanNumber(e.target.value)} className="bg-gray-50 border border-gray-600 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-bold" placeholder="XXXXX1234X" type="text"/>
                  </div>
