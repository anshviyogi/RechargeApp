...
const Navbar = (props) => {
  ...
  const localStorageItems = JSON.parse(localStorage.getItem("loggedInUser"))
        ...
        <Dropdown
          button={
            <img
              ...
              src={'https://www.cariblist.com/admin/assets/img/UserLogos/1473851754-avatar-generic.jpg'}
              alt="Elon Musk"
            />
          }
          children={
